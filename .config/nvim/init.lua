  ...
  -- Plugins {{{
  {
    ...
    },
    {
      ...
      opts = {
        ...
        -- ts_context_commentstring determines correct comment style in
        -- tsx/jsx where JS and JSX regions need different comments.
        -- Falls back to vim.bo.commentstring for filetypes without treesitter
        -- (e.g. env) to work around a Comment.nvim bug where get_parser
        -- returns nil without erroring, causing ft.contains(nil) to crash.
